...
export function fileErrorHandler(err, req, res, next) {
...
function validateForumIdExists(value) {
...
function validateThreadIdExists(value) {
...
function validateMessageIdExists(value) {
...
function validateMessageIdExistsNotDeleted(value) {
...
function validateNewPassword(value, { req }) {
...
function validateUserIdExists(value) {
