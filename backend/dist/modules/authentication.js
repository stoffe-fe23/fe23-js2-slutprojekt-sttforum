...
userAPI.post("/login", passport.authenticate('local', { failWithError: true }), loginAuthenticationError, (req, res, next) => {
...
function loginAuthenticationError(err, req, res, next) {
